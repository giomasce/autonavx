...
class UserCode:
    def __init__(self):
        ...
        Kp_z  = 2 # z proportional
        Kd_z  = 1 # z differential
    ...
    def compute_control_command(self, t, dt, state, state_desired):
        ...
        dist_pos = state_desired.position - state.position
        dist_vel = state_desired.velocity - state.velocity

        u = self.Kp * dist_pos + self.Kd * dist_vel
